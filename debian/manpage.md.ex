% gz-cmake3(SECTION) | User Commands
%
% "March  7 2023"
...
gz-cmake3 - program to do something

# SYNOPSIS

**gz-cmake3** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gz-cmake3** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gz-cmake3** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gz-cmake3** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gz-cmake3. See **foo.conf**(5) for further details.
...
**gz-cmake3** provides some return codes, that can be used in scripts:
